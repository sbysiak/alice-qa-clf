...
runLevelQA()
{
  ...
  grep "pTreeBeamSpot" MakeTrend.C
  if [[ $? != 0 ]]; then 
      echo "pTreeBeamSpot NOT found in MakeTrend.C"
      echo "Probably MakeTrend.C was replaced during rebuilding of the software."
      echo "Try running following command:"
      echo "cp ~/.sw/slc7_x86-64/AliPhysics/master_ROOT6-1/PWGPP/TPC/macros/MakeTrend.C.modified  ~/.sw/slc7_x86-64/AliPhysics/master_ROOT6-1/PWGPP/TPC/macros/MakeTrend.C"
      exit 1
  fi
