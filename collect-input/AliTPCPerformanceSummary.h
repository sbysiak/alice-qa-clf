...
class AliTPCPerformanceSummary
{
    ...
    static void WriteToTTreeSRedirectorChunk(const AliPerformanceTPC* pTPC, const AliPerformanceDEdx* pTPCgain, const AliPerformanceMatch* pTPCMatch, const AliPerformanceMatch* pTPCPull, const AliPerformanceMatch* pConstrain, TTree* pTreeBeamSpot, TTreeSRedirector* const pcstream, Int_t run = -1); // called by WriteToFile
    ...
    static void WriteToFileChunk(const AliPerformanceTPC* pTPC, const AliPerformanceDEdx* pTPCgain, const AliPerformanceMatch* pMatch,const AliPerformanceMatch* pPull, const AliPerformanceMatch* pConstrain, TTree* pTreeBeamSpot, const Char_t* outfile, Int_t run = -1); // calles by MakeReport
    ...
    static Int_t AnalyzeChunk(TTree* pTreeBeamSpot, TTreeSRedirector* const pcstream, const Int_t samplingPeriod=5);
